...
public class RegistaController {
	...
	public String delete(@PathVariable(required = true) Long idRegista, Model model, Regista regista, RedirectAttributes redirectAttrs) {
		
		Regista regista2= registaService.caricaSingoloElemento(idRegista);
		
		if (regista2.getFilms().size() != 0) {
			redirectAttrs.addFlashAttribute("errorMessage", "Non puoi eliminare un regista che cia dei film associati");
			return "redirect:/regista";
		}
