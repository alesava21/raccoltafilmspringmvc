							...
							<form:form modelAttribute="edit_film_attr"  method="post" action="${pageContext.request.contextPath }/film/update" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									...
									<spring:bind path="minutiDurata">
										<input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="minutiDurata" id="minutiDurata" placeholder="Inserire la durata in minuti" value="${edit_film_attr.minutiDurata }" required>
									</spring:bind>
