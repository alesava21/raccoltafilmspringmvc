...
public class FilmController {
	...
	public String showFilm(@PathVariable(required = true) Long idFilm, Model model) {
		model.addAttribute("show_film_attr",
				FilmDTO.buildFilmDTOFromModel(filmService.caricaSingoloElementoEager(idFilm), true));		return "film/show";
	}
	
	@GetMapping("/delete/{idFilm}")
	public String delete(@PathVariable(required = true) Long idFilm, Model model, Regista regista) {
		model.addAttribute("delete_film_attr", FilmDTO.buildFilmDTOFromModel(filmService.caricaSingoloElemento(idFilm), true));
		return "film/delete";
	}
